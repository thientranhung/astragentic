...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/failure_modes-122_measured-red" alt="failure modes">
</p>
...
cd <target-repo>
claude "Read .astraler/releases/2.3.20/ADAPT-HARNESS.md completely and execute it."
...
| **Failure mode** | 122 đo lường được, evidence base chỉ thêm không xoá |
