...
colors:
  ...
  canvas: "#F2F3F6"
  canvas-grid-a: "#FDF1EE"
  canvas-grid-b: "#F5C9C1"
  canvas-grid-c: "#E9968B"
  surface: "#FFFFFF"
...
- **Island** (`box-shadow: 0 1px 2px rgba(20,22,26,.06), 0 12px 40px rgba(120,40,30,.16)`): the whole page frame, once.
